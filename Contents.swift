...
// Storing the number of units in an apartment complex. int
// Storing your highscore in a game. var
// Storing the number of letters in an alphabet. int
...
// Changes depending on how your progession is
var stepGoal: Int
